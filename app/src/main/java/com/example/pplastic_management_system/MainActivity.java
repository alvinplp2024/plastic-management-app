...
public class MainActivity extends AppCompatActivity {
    ...
    CardView donate, receive, logout, foodmap, about, contact, mypin, history,complainhisto;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        complainhisto = findViewById(R.id.cardCompainHistory);
        ...
        complainhisto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),HistoryComplain.class);
                startActivity(intent);
            }
        });
